...
export default function JourneyTimeline() {
  ...
  return (
    <section id="timeline" ref={containerRef} className="relative py-16 md:py-40 bg-[#F8F8F5] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
         ...
         <motion.div 
           ...
           className="absolute top-[5%] md:top-[10%] right-[10%] md:right-[15%] w-16 h-24 md:w-24 md:h-32 opacity-60"
         >
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="text-center mb-16 md:mb-32 relative z-20">
          <motion.h2 
            ...
            className="font-heading text-4xl md:text-6xl font-bold text-[#1B1B1B] mb-3 md:mb-4"
          >
          ...
          <motion.p 
             ...
             className="text-textMuted text-base md:text-lg max-w-xl mx-auto px-4"
          >
        ...
        <div className="relative w-full max-w-[1000px] mx-auto">
          ...
          <div className="absolute left-6 md:hidden top-0 bottom-0 w-[40px] bg-[#2B2B2B] rounded-full overflow-hidden shadow-xl z-0">
            ...
            {stops.map((stop, index) => {
              ...
              return (
                <div key={stop.id} className={`flex flex-col md:flex-row items-center w-full ${isEven ? "md:justify-start" : "md:justify-end"} pl-[72px] sm:pl-24 md:pl-0 relative`}>
                  ...
                  <div className="absolute left-6 md:left-1/2 top-[50px] md:top-1/2 -translate-y-1/2 md:-translate-x-1/2 w-4 h-4 md:w-6 md:h-6 bg-white border-[3px] md:border-4 border-[#1F5E45] rounded-full z-10 shadow-[0_0_10px_rgba(31,94,69,0.5)] md:shadow-[0_0_15px_rgba(31,94,69,0.5)] ml-[12px] md:ml-0" />
                  ...
                  >
                    <div className="group flex flex-col sm:flex-row bg-white/70 backdrop-blur-md rounded-[16px] md:rounded-[20px] shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-black/5 overflow-hidden hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(0,0,0,0.12)] transition-all duration-500 cursor-pointer">
                      
                      {/* Image Preview (Left side) */}
                      <div className="w-full sm:w-2/5 h-32 sm:h-auto relative overflow-hidden">
                        <img 
                          src={stop.image} 
                          alt={stop.location}
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-3 md:p-4">
                      ...
                      {/* Content (Right side) */}
                      <div className="w-full sm:w-3/5 p-4 md:p-6 flex flex-col justify-center relative">
                        ...
                        <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-3">
                          ...
                          <span className="text-[9px] md:text-[10px] font-bold tracking-[0.2em] uppercase text-[#6B7280]">
                            {stop.phase}
                          </span>
                        </div>

                        {/* Title & Desc */}
                        <h3 className="font-heading text-lg md:text-2xl font-bold text-[#1B1B1B] mb-1 md:mb-2">
                          {stop.location}
                        </h3>
                        <p className="text-xs md:text-sm text-textMuted leading-relaxed mb-4 md:mb-6">
                          {stop.description}
                        </p>

                        {/* Animated View Details Button */}
                        <div className="flex items-center gap-2 text-xs md:text-sm font-bold text-[#1F5E45] overflow-hidden">
                          <span className="transform transition-transform duration-300">
                            View Details
                          </span>
                          <ArrowRight className="w-[14px] h-[14px] md:w-4 md:h-4 transform -translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300" />
                        </div>
